...
"h=Help u=UC_toggle v={Verbose, toggle EOJ stats} m={progress Meter}\n"\
"q={PBN Quiet mode} V={show Version info and exit}\n" \
...
"L={Set RP Library Mode and Path. Default Path = ../rpdd.zrd \n"\
...
"T={Title in quotes} U={DealerServer pathname}\n" \
