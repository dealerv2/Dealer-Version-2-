/* File dll4.h in Drafts folder -- Bunch of stuff removed for easier reading by JGM 2021-09-24 */
...
// This next struct seems not to work on Linux boxes as the GetDDSInfo function coredumps
struct DDSInfo {
